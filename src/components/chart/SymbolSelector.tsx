      ...
      >
        ...
        <div className="border-b border-tv-border p-3 space-y-2">
          <Input
            ...
            className="bg-tv-bg text-base sm:text-sm h-10"
          />
          ...
          {filtered.map((s) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex w-full items-center justify-between border-b border-tv-border px-4 py-3 sm:py-2.5 text-left hover:bg-tv-panel-hover active:bg-tv-panel-hover",
